...
JOB_DIR="pretrain_1024_fineweb_eurollm2"
DATA_PATH="eurollm-fineweb-100k/eurollm_processed_data_text_document"
...
DATA_ARGS=(
    ...
    --tokenizer-model `dirname $(readlink -f "${BASH_SOURCE[0]}")`/../../resource/tokenizer/euroLLM/tokenizer.model
    --split 999,1,0
