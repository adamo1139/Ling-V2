...
TOKENIZER_PATH="/home/ubuntu/preprocessing/Ling-V2/resource/tokenizer/apt4"
...
echo "Processing chunks with APT4 tokenizer..."
PYTHONPATH=${MEGATRON_PATH}:$PYTHONPATH python3 /home/ubuntu/preprocessing/Ling-V2/preprocess_chunks_parallel.py \
    --chunks-dir ${CHUNKS_DIR} \
    --output-prefix apt4_processed_data_chunks \
...
echo "  apt4_processed_data_chunks_text_document.bin"
echo "  apt4_processed_data_chunks_text_document.idx"
echo ""
