...
MODEL_PATH="/home/adamo/projects/pretrain/Ling-V2/poziomka_10_dcp"
JOB_DIR="poziomka_11"
DATA_PATH="/home/adamo/projects/pretrain/Ling-V2/speakleash_forums_tokenized_apt4/speakleash_merged_text_document"
...
if [ ! -f "${TRACKER_FILE}" ]; then
    ...
    echo "Create it with: echo 6000 > ${TRACKER_FILE}"
    exit 1
fi
...
export NVTE_FLASH_ATTN=1 # get that sweet FA2 boost
